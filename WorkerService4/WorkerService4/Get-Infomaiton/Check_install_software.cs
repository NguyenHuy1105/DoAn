...
{
    public static class CHECK_INSTALL_SOFTWARE
    {
        /// <summary>
        /// Retrieves the check time for installing software.
        /// </summary>
        ...
        public static async Task<int?> GetCheckTimeInstallSoftware(HttpClient httpClient, ApiConfig apiConfig, CancellationToken stoppingToken)
        {
            try
            {
                // Construct the URL from the base URL and the CheckInstallSoftware endpoint
                string url = $"{apiConfig.BaseUrl}{apiConfig.ApiEndpoints.CheckInstallSoftware}";
